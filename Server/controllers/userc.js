...
import { createJWT } from '../utils/index1.js';
...
export const updateUserProfile = async (req,res) => {
  try{
    ...
    ? userId : isAdmin && userId !== _id ? _id : userId;
    ...
    if(user) {
      ...
      user.password = undefined;
      res.status(201).json({
        status:true, message: "Profile Updated Successfully", user: updateUser
      })
    } else {
